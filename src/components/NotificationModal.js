...
export default function NotificationModal({ message, onClose }) {
  return (
    <div className="absolute bottom-8 sm:bottom-10 bg-green-50 border border-green-300 shadow-md rounded-2xl px-6 py-4 flex items-center gap-4 
        opacity-0 scale-95 animate-fade-slow-in transition-all duration-700 ease-out
    ">
